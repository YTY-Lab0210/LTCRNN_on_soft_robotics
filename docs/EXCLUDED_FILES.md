...
The original working folder contains many files that are not suitable for a clean GitHub repository. They were intentionally not copied into this release folder.

Excluded categories:

```text
_unused_datasets_backup_20260717/   Old dataset backups
.codex_tmp/                         Temporary generated files
