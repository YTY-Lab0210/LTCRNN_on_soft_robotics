...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("🚀 開始訓練 LSTM(16) 單一模型以繪製學習曲線")
    print("="*50)

    # --- A. 建立 LSTM 模型 (16 顆神經元) ---
    ...
    try:
        plot_model(
            model, 
            to_file='lstm16_architecture.png', 
            show_shapes=True,      
            show_layer_names=True, 
            show_layer_activations=True 
        )
        print("✅ 模型架構圖已成功儲存為 lstm16_architecture.png")
    ...
    # 🌟 修改標題為 LSTM
    fig.suptitle('LSTM_16neuron Training Results', fontsize=18, fontweight='bold', y=1.02)
    ...
    # Loss 預留較大空間，因為 LSTM 沒學好時 Loss 可能會衝很高
    ...
    # 存檔 (🌟 修改檔名為 LSTM)
    plt.savefig('LSTM_16neuron_Training_Results.png', dpi=300, bbox_inches='tight')
    print("✅ 訓練曲線已成功儲存為 LSTM_16neuron_Training_Results.png！\n")